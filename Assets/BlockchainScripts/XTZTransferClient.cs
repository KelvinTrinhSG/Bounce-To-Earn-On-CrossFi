...
public class XTZTransferClient : MonoBehaviour
{
    [Header("Server URL")]
    private string serverUrl = "https://crossfi-bounce-to-earn-backend.onrender.com/transfer";
    ...
    public WalletBalanceButtonTrigger walletBalanceButtonTrigger;
    ...
    IEnumerator SendClaimRequest(string to, float amount)
    {
        ...
        using (UnityWebRequest request = new UnityWebRequest(serverUrl, "POST"))
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                walletBalanceButtonTrigger.UpdateWalletBalance();
            }
            else
            {
